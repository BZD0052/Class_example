...
You can name chunk and other option also like showing code chunk or not
by using “include” like {r R code example, include= TRUE }; echo for
displaying code or not (if FALSE= code is not displayed)
